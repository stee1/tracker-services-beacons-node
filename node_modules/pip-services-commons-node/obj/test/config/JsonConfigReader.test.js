...
var JsonConfigReader_1 = require("../../src/config/JsonConfigReader");
suite('JsonConfigReader', function () {
    test('Config Sections', function () {
        var parameters = ConfigParams_1.ConfigParams.fromTuples("param1", "Test Param 1", "param2", "Test Param 2");
        var config = JsonConfigReader_1.JsonConfigReader.readConfig(null, "./data/config.json", parameters);
